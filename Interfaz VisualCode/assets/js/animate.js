jQuery(document).ready(function($) {
	...
	//efecto entrada que se desvanece
	$(".e_fadeIn").hover(
		function () {
	...
	//efecto Salidas de desvanecimiento
	$(".e_fadeOut").hover(
		function () {
