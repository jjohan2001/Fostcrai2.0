var app = {
    ...
    init: function(){
        ...
        $('#save').click(function(){
            ...
            app.save({
                id_capacitacion :$('#id').val(),
                fecha_capacitacion : $('#fecha').val(),
                horas_capacitacion : $('#horas').val(),
            });
        });
    },
...
$.getJSON("litaRecreador", app.backend+{}, function(data){
    $.each(data, function(i,item){
        $("#id_reg_inventario").append("<option value="+item.id+">"+ item.id +"</option");
    });
});
