...
public class Cliente {
	...
	public Cliente(Long id_cliente, String nombre, String apellido, String cedula, String celular, String correo,
	...
	public String toString() {
		return "Cliente [id_cliente=" + id_cliente + ", nombre=" + nombre + ", apellido=" + apellido + ", cedula=" + cedula
